...
import {AImessage, Usermessage,AImessage2} from './Messages'
...
<FadeInSection className="flex-1 overflow-hidden flex">
        ...
        <div className="flex-1 flex flex-col relative">
          ...
          >
            ...
            <AImessage/>
            {/* User Message */}
           <Usermessage text={"Can you explain recursion in the context of Depth First Search? I always get confused about how the stack handles the backtracking."}/>
            {/* AI Message */}
            <AImessage2/>
