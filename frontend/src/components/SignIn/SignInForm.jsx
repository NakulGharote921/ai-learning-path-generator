    ...
    <div className="signup-form w-full md:w-1/2 h-full bg-surface overflow-y-auto flex items-center justify-center p-md md:p-xl">
      <div className="w-full max-w-md flex flex-col signup-card">
        ...
        <div className="flex flex-col gap-sm mb-lg">
          <button onClick={handleGoogleSignIn} className="flex items-center justify-center gap-sm w-full py-sm px-md rounded-xl border border-outline-variant bg-surface-container-lowest hover:bg-surface-container-low transition-colors duration-200">
